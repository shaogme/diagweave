...
- `metadata: { error_code: string|integer|null, severity: "debug"|"info"|"warn"|"error"|"fatal"|null, observability_level: "trace"|"debug"|"info"|"warn"|"error"|"fatal"|null, category: string|null, retryable: boolean|null }`
